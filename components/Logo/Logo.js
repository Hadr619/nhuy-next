...
export default function Logo({viewbox}) {
    ...
    return (
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox={newBox()} className={styles.svg}>
<path className={styles.heart} d="M97.3,14.7c-3.3,0-6.4,1.1-8.8,3c-2.4-1.9-5.5-3-8.8-3c-7.9,0-14.2,6.4-14.2,14.2c0,7.9,15.2,24,23,24
	s23-16.1,23-24C111.6,21.1,105.2,14.7,97.3,14.7z"/>
<path className={styles.lines} d="M112.4,35.6c1.1-2.2,1.9-4.5,1.9-6.6c0-9.3-7.6-16.9-16.9-16.9c-3.1,0-6.1,0.8-8.8,2.5c-2.6-1.6-5.6-2.5-8.8-2.5
...
<g className={styles.name}>
	<path className={styles.lines} d="M40.6,166.2c-3.1,3.9-7.7,9.6-13.8,17.3c-0.9-0.7-2.1-1.7-3.8-3c2.7-3.4,6.8-8.5,12.2-15.4c-0.9-0.7-2.1-1.7-3.9-3.1
	...
	<path className={styles.lines} d="M57.7,172.8c-1.9,3.9-3.3,6.9-4.3,8.8c-1,2-1.7,3.4-2.1,4.4c-1.9,3.9-3.3,6.9-4.3,8.8c-2-1-3.4-1.7-4.4-2.1
	...
	<path className={styles.lines} d="M74.7,177.7c-1.1,4.8-2.8,11.9-5,21.5c-0.2,0.7-0.5,1.2-1.1,1.5c-0.6,0.4-1.2,0.5-1.9,0.3c-2.1-0.5-5.3-1.3-9.6-2.2
	...
	<path className={styles.lines} d="M95.3,178.6c-2.9,6-5.1,10.6-6.5,13.6c0.1,5.5,0.1,9.2,0.2,11.1c-2.5,0-4.1,0.1-4.9,0.1c-0.1-5.5-0.1-9.2-0.2-11.1
	...
	<path className={styles.lines} d="M112.5,187.9c0.6-0.2,1.3,0,1.9,0.3c0.6,0.3,0.9,0.9,1.1,1.5c0.5,2.1,1.3,5.3,2.3,9.6c-1.1,0.3-2.6,0.6-4.8,1.1
	...
	<path className={styles.lines} d="M121.7,177.2c1,2,1.7,3.4,2.2,4.4c3-1.4,5.2-2.5,6.6-3.2c1,2,1.7,3.4,2.1,4.4c-3,1.4-5.2,2.5-6.6,3.2c1,2,1.7,3.4,2.2,4.4
	...
	<path className={styles.lines} d="M131.4,166.6c0.7-0.5,2-1.4,4-2.8c1.8,2.5,5.3,7.5,10.7,15c0.6,0.8,1.8,2.5,3.6,5c-0.7,0.5-2,1.4-4,2.8
		c-1.2-1.7-3-4.2-5.3-7.5C138,175.8,135,171.7,131.4,166.6z"/>
	<path className={styles.lines} d="M150.8,153.5c3.1,3.1,7.7,7.7,13.9,13.9c0.5,0.5,0.7,1.1,0.7,1.7c0,0.7-0.2,1.3-0.7,1.7c-1.2,1.2-2.9,2.9-5.2,5.2
...
<g>
	<ellipse className={styles.lines} transform="matrix(0.913 -0.408 0.408 0.913 -33.4359 49.7126)" cx="99.8" cy="103.2" rx="5.8" ry="10.3"/>
	<ellipse className={styles.lines} transform="matrix(0.408 -0.913 0.913 0.408 -48.3781 131.8593)" cx="77.5" cy="103.2" rx="10.3" ry="5.8"/>
	<path className={styles.lines} d="M122.5,112.9c1.9-4.9,2.9-9.7,2.9-14.3c0-18.2-16.9-34.3-36.6-35.4c-0.2,0-0.4,0-0.6,0c-19.7,1.1-36.6,17.2-36.6,35.4
	...
	<g>
		...
		<path className={styles.lines} d="M88.6,112.1c0,0-4.1,1.9-4.1,4.5c0,2.6,2.6,2.6,2.6,2.6l1.6-0.6l1.9,0.6c0,0,2.5-0.6,2.4-2.7
